            ...
            <li class="li-mobile">
                ...
                <div class="menu-bd block">
                    ...
                    <div class="site-cate site-market">
                        ...
                        <ul>
                                                    <li><a href="category.php?id=2">CDMA手机</a></li>
                                                    <li><a href="category.php?id=3">GSM手机</a></li>
                                                    <li><a href="category.php?id=4">3G手机</a></li>
                                                    <li><a href="category.php?id=5">双模手机</a></li>
                                                </ul>
                    </div>
    ...
    <div class="main-nav clearfix block">
        ...
        <div class="cate-tree none">
            ...
            <ul class="ul-cate-tree">
                    ...
                    <i class="iconfont">&#xe603;</i>                                                                                                                                                                                                                                                                                                                                <a href="category.php?id=2" title="CDMA手机">CDMA手机</a>
                </li>
                                                                <li class="cate-tree-item">
                                        <i class="iconfont">&#xe604;</i>                                                                                                                                                                                                                                                                                                            <a href="category.php?id=3" title="GSM手机">GSM手机</a>
                </li>
                                                                <li class="cate-tree-item">
                                                            <i class="iconfont">&#xe601;</i>                                                                                                                                                                                                                                                                                        <a href="category.php?id=4" title="3G手机">3G手机</a>
                </li>
                                                                <li class="cate-tree-item">
                                                                                <i class="iconfont">&#xe600;</i>                                                                                                                                                                                                                                                                    <a href="category.php?id=5" title="双模手机">双模手机</a>
                </li>
                                            </ul>
...
<div class="blank"></div>
 <div id="ur_here">
当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">手机类型</a> <code>&gt;</code> <a href="category.php?id=5">双模手机</a> 
</div>
</div>
<div class="blank"></div>
...
<div class="box1 cate" id="cate">
  ...
  <a   style="border-top:none"  href="category.php?id=2" class="  f_ll" >CDMA手机</a>
  ...
  <a   href="category.php?id=3" class="  f_ll" >GSM手机</a>
  <ul style="display:none" class="sub-tree">
      </ul>
  <div style="clear:both"></div>
    <h1 onclick="tab(2)"    >
  ...
  <a   href="category.php?id=4" class="  f_ll" >3G手机</a>
  <ul style="display:none" class="sub-tree">
      </ul>
  <div style="clear:both"></div>
    <h1 onclick="tab(3)"    >
  ...
  <a   href="category.php?id=5" class="  f_ll" >双模手机</a>
  <ul style="display:none" class="sub-tree">
      </ul>
  <div style="clear:both"></div>
  </div>
...
<div class="box">
 <div class="box_1">
  ...
  <form method="GET" class="sort" name="listform">
    ...
    <li>  <a href="category.php?category=5&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list">
    <img src="themes/ecmoban_tianmao2016/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
    </li>
    <li>  <a href="category.php?category=5&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">
    <img src="themes/ecmoban_tianmao2016/images/shop_price_default.gif" alt="按价格排序"></a>
    </li>
    <li>  <a href="category.php?category=5&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list">
      ...
      <form name="compareForm" action="compare.php" method="post" onSubmit="return compareGoods(this);">
        ...
        <div class="info">
          ...
          <a href="goods.php?id=23" class="buy" target="_blank">立即购买</a>
                  ...
                  <div class="goodsItem"> <a href="goods.php?id=8" target="_blank"><img src="images/200905/thumb_img/8_thumb_G_1241425513488.jpg" alt="飞利浦9@9v" class="goodsimg" /></a><br />
        <p class="name"><a href="goods.php?id=8" title="飞利浦9@9v" target="_blank">飞利浦9@9v</a></p>
        <div class="info">
          <p class="price">
          ...
          <p class="market">￥479元</p>
          <a href="goods.php?id=8" class="buy" target="_blank">立即购买</a>
        </div>
      </div>
            </div>
        </form>
...
</script><form name="selectPageForm" action="/ecshop/upload/category.php" method="get">
